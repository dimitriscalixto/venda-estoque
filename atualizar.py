...
class  Tela:
    def __init__(self,master):
        ...
        self.top_level.title("Formulário Cadastro")
        self.top_level.geometry('500x500')
        self.heading = ttk.Label(self.top_level,text="Atualizar Produtos",font=('arial 20 bold'))
        ...
        self.id = ttk.Label(self.top_level, text="Digite o ID:", font=('arial 10'))
        ...
        self.btn_procura = ttk.Button(self.top_level, text="Pesquisar",width=15,command=self.procurar_id)
        self.btn_procura.place(x=270,y=370)
        self.btn_add = ttk.Button(self.top_level, width= 25, text="Atualizar",command=self.atualizar)

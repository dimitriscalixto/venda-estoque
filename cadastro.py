...
class  Tela:
    def __init__(self,master):
        ...
        self.heading = ttk.Label(self.janela,text="Cadastro de Produtos",font=('arial 20 bold'))
        ...
        self.id = ttk.Label(self.janela, text="ID:", font=('arial 10'))
        ...
        self.btn_add = ttk.Button(self.janela, width= 25, text="Cadastrar",command=self.get_items)
